...
public class RegionController {
    ...
    public Result<List<CityInfo>> listCityInfoByProvinceId(@RequestParam Long id) {
        ...
        cityQueryWrapper.eq(CityInfo::getProvinceId, id);
        List<CityInfo> list = cityInfoService.list(cityQueryWrapper);
        return Result.ok(list);
    }
    ...
    public Result<List<DistrictInfo>> listDistrictInfoByCityId(@RequestParam Long id) {
        ...
        districtQueryWrapper.eq(DistrictInfo::getCityId, id);
        List<DistrictInfo> list = districtInfoService.list(districtQueryWrapper);
        return Result.ok(list);
    }
}
